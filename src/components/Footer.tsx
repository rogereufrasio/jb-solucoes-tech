    ...
    <footer className="site-footer">
      <div className="container footer-inner">
        ...
        <div className="footer-links">
          ...
          <span>© {currentYear} {siteConfig.brand.name}</span>
          <span className="developer-credit">Desenvolvido por <a href="https://github.com/rogereufrasio" target="_blank" rel="noopener noreferrer">Roger Eufrasio</a></span>
        </div>
      </div>
    </footer>
  )
