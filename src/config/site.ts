...
export const siteConfig = {
  ...
  whatsapp: {
    ...
    defaultMessage: 'Olá! Encontrei a JB Soluções Tech pelo site e gostaria de solicitar uma avaliação.',
  },
  navigation: [
  ...
  services: [
    { id: 'computadores', icon: 'PC', title: 'Computadores e notebooks', description: 'Diagnóstico e configuração para equipamentos mais funcionais.', examples: ['Hardware e software', 'Formatação e sistemas', 'Otimização e periféricos'], whatsappMessage: 'Olá! Encontrei a JB Soluções Tech pelo site e gostaria de solicitar uma avaliação para computador ou notebook.' },
    { id: 'redes', icon: 'WI', title: 'Redes e Wi-Fi', description: 'Conectividade organizada para residências e pequenos negócios.', examples: ['Roteadores e repetidores', 'Cobertura Wi-Fi', 'Conexões e cabeamento'], whatsappMessage: 'Olá! Encontrei a JB Soluções Tech pelo site e gostaria de solicitar uma avaliação para melhorar minha rede Wi-Fi.' },
    { id: 'impressoras', icon: 'IP', title: 'Impressoras e equipamentos', description: 'Instalação e integração de equipamentos ao seu ambiente.', examples: ['Impressoras e scanners', 'Periféricos', 'Integração à rede'], whatsappMessage: 'Olá! Encontrei a JB Soluções Tech pelo site e gostaria de solicitar uma avaliação para impressora ou equipamento.' },
    { id: 'home-office', icon: 'HO', title: 'Home office', description: 'Uma estrutura de trabalho conectada e pronta para a rotina.', examples: ['Computador e webcam', 'Headset e impressora', 'Conectividade'], whatsappMessage: 'Olá! Encontrei a JB Soluções Tech pelo site e gostaria de solicitar uma avaliação para organizar meu home office.' },
    { id: 'negocios', icon: 'PN', title: 'Pequenos negócios', description: 'Tecnologia organizada para apoiar a operação do dia a dia.', examples: ['Computadores e rede', 'Compartilhamento', 'Suporte técnico'], whatsappMessage: 'Olá! Encontrei a JB Soluções Tech pelo site e gostaria de solicitar uma avaliação para meu pequeno negócio.' },
    { id: 'orientacao', icon: 'OT', title: 'Orientação e treinamento', description: 'Apoio prático para usar tecnologia com mais segurança.', examples: ['Informática básica', 'Uso seguro da internet', 'Ferramentas digitais'], whatsappMessage: 'Olá! Encontrei a JB Soluções Tech pelo site e gostaria de saber mais sobre orientação e treinamento em tecnologia.' },
  ] satisfies Service[],
  howItWorks: {
  ...
  diagnostic: {
    ...
    needOptions: ['Computador ou notebook', 'Rede ou Wi-Fi', 'Impressora ou equipamento', 'Home office', 'Pequeno negócio', 'Orientação ou treinamento', 'Outro assunto de tecnologia'],
    submitLabel: 'Enviar diagnóstico pelo WhatsApp',
  },
  about: {
    eyebrow: 'Sobre',
    title: 'Tecnologia mais simples e acessível',
    description: 'A JB Soluções Tech foi criada por Jonathan Braga para ajudar pessoas e pequenos negócios a resolver problemas de conectividade, configuração e uso de equipamentos com atendimento próximo e transparente.',
  ...
  faq: [
    ...
    { question: 'Que tipos de problema a JB Soluções Tech atende?', answer: 'A JB atua com computadores e notebooks, redes e Wi-Fi, impressoras e equipamentos, home office, tecnologia para pequenos negócios e orientação digital.' },
  ...
  finalCta: { title: 'Precisa resolver um problema de tecnologia?', description: 'Conte o que está acontecendo e inicie uma avaliação pelo WhatsApp.', action: 'Falar com a JB Soluções Tech' },
  legal: {
    privacy: {
      title: 'Política de Privacidade',
      intro: 'Esta política explica de forma simples como o site da JB Soluções Tech funciona em relação aos seus dados.',
      sections: [
    ...
    terms: {
      ...
      sections: [
        { title: 'Finalidade do site', paragraphs: ['A página apresenta os serviços de tecnologia da JB Soluções Tech e facilita o primeiro contato pelo WhatsApp. O conteúdo tem caráter informativo.'] },
  ...
  seo: { title: 'JB Soluções Tech | Tecnologia simples e atendimento de confiança', description: 'Suporte para computadores, redes, Wi-Fi, impressoras e home office com atendimento direto e sem complicação.', canonicalUrl: '', ogImage: assetUrl('og.png') },
